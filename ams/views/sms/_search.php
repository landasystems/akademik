...
<?php echo $form->textFieldRow($model, 'count_message', array('class' => 'span5')); ?>
<?php echo $form->textFieldRow($model, 'last_message', array('class' => 'span5')); ?>
...
<?php // echo $form->textAreaRow($model, 'last_message', array('rows' => 6, 'cols' => 50, 'class' => 'span8')); ?>
...
<?php // echo $form->textAreaRow($model, 'type_phones', array('rows' => 6, 'cols' => 50, 'class' => 'span8')); ?>

    <?php // echo $form->textAreaRow($model, 'type_roles_ids', array('rows' => 6, 'cols' => 50, 'class' => 'span8')); ?>
...
<script type="text/javascript">
    jQuery(function($) {
        $(".btnreset").click(function() {
            $(":input", "#search-sms-form").each(function() {
                var type = this.type;
