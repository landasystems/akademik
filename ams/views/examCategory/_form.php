    ...
    <fieldset>
        ...
        <?php echo $form->errorSummary($model,'Opps!!!', null,array('class'=>'alert alert-error span12')); ?>
                                ...
                                <div class="control-group ">
                                            ...
                                            <div class="controls">
                                <?php echo CHtml::dropDownList('ExamCategory[parent_id]', $model->parent_id, CHtml::listData(ExamCategory::model()->findAll(array('order' => 'root, lft')), 'id', 'nestedname'), array('class' => 'span3', 'empty' => 'root')); ?>
                                                 </div>
                                        </div>
