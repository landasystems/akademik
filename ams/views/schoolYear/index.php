<?php
$this->setPageTitle('School Years');
...
$('.search-form form').submit(function(){
    $.fn.yiiGridView.update('school-year-grid', {
        data: $(this).serialize()
    });
    return false;
});
...
if (landa()->checkAccess('SchoolYear', 'r'))
    $buton .= '{view}';

if (landa()->checkAccess('SchoolYear', 'u'))
    $buton .= '{update} ';

if (landa()->checkAccess('SchoolYear', 'd'))
    $buton .= '{delete}';
