...
class DualSelect extends CWidget {
    ...
    <div class="span12">
        ...
        <div class="dualBtn">
            <button id="to2" type="button" class="btn"><span class="icon12 icon-arrow-right"></span></button>
            <button id="allTo2" type="button" class="btn"><span class="icon12 icon-forward"></span></button>
            <button id="to1" type="button" class="btn marginT5"><span class="icon12 icon-arrow-left"></span></button>
            <button id="allTo1" type="button" class="btn marginT5"><span class="icon12 icon-backward"></span></button>
        </div>
