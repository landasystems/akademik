...
//        }
    ...
    public function actionGenerateExcel() {
        ...
        if (isset($session['SmsKeyword_records'])) {
            $model = $session['SmsKeyword_records'];
        } else
            $model = SmsKeyword::model()->findAll();
    ...
    public function actionGeneratePdf() {
        ...
        $pdf->SetTitle('Laporan SmsKeyword');
        $pdf->SetSubject('Laporan SmsKeyword Report');
        //$pdf->SetKeywords('example, text, report');
        $pdf->SetHeaderData('', 0, "Report", '');
        //$pdf->SetHeaderData(PDF_HEADER_LOGO, PDF_HEADER_LOGO_WIDTH, "Laporan" SmsKeyword, "");
        $pdf->SetHeaderData("", "", "Laporan SmsKeyword", "");
        ...
        $pdf->LastPage();
        $pdf->Output("SmsKeyword_002.pdf", "I");
    }
