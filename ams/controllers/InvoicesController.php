...
class InvoicesController extends Controller
{
	...
	{
                $modelInvoicesDetail = InvoicesDetail::model()->findAll(array('condition'=>'invoices_id='.$id));
		$this->render('view',array(
			'model'=>$this->loadModel($id),
			'modelInvoicesDetail'=>$modelInvoicesDetail,
		));
	}
	...
	public function actionIndex()
	{
                ...
                if(isset($_GET['Invoices']))
		{
                       ...
                       if (!empty($model->payment)) $criteria->addCondition('payment = "'.$model->payment.'"');
                 ...
                 $session['Invoices_records']=Invoices::model()->findAll($criteria); 
        ...
        public function actionGenerateExcel()
	{
            ...
            $session->open();		
             ...
             if(isset($session['Invoices_records']))
               {
                $model=$session['Invoices_records'];
               }
               else
                 $model = Invoices::model()->findAll();
        ...
        public function actionGeneratePdf() 
	{
		...
		$pdf->SetTitle('Laporan Invoices');
		$pdf->SetSubject('Laporan Invoices Report');
		//$pdf->SetKeywords('example, text, report');
		$pdf->SetHeaderData('', 0, "Report", '');
		//$pdf->SetHeaderData(PDF_HEADER_LOGO, PDF_HEADER_LOGO_WIDTH, "Laporan" Invoices, "");
		$pdf->SetHeaderData("", "", "Laporan Invoices", "");
