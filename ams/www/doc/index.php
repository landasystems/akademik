...
require_once(dirname(__FILE__).'/../../../common/config/akademik.smpplusalkautsar.php'); // change this line for configuration
...
$config_index = array('theme' => 'wba'); // change this line for configuration
