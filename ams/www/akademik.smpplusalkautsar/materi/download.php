		...
		<!--logo-->
			...
			<div class="row">
				<div class="span12">
					...
					<!--logo-->			
					<div class="logo">
						 <a href="#"><img src="logo.png" alt="" class="animated bounceInDown"></a>  
					</div>
					<!--menu-->	
					<ul class="nav navbar-nav navbar-right">
                                            <li><a href="../index.php"><h2><span class="glyphicon glyphicon-home"></span></h2></a></li>
                                            <li><form action="/search" class="form-inline" id="searching" method="get" role="form"><div class="form-group"><input class="form-control" id="nyari" name="q" placeholder="Search..." type="text"></div><button class="btn btn-default" id="diklik" type="submit"><span class="glyphicon glyphicon-search"></span> </button></form></li>
</ul>
					...
					<div class="row">
						...
						<div class="inner_content">
                                                    ...
                                                    $title = $mtk->title($id);
                                                    foreach ($title as $ss){
                                                       echo'<h1 class="title" font face="Segoe Print" color="green">Download '.$ss['name'].'</h1></font>';
                                                    }
                                                    ?>
...
<div class="container">
  ...
  <table class="table">
    ...
    <tbody>
        ...
        <td>".$a['url']."</td>
        <td>".$a['created']."</td>
        <td><a type='button' class='btn btn-default btn-sm' href='".$a['url']."'>
...
<center><nav>
  <ul class="pagination">
    <li>
      <a href="matematika.html" aria-label="Previous">
        <span aria-hidden="true"><-previous</span>
      </a>
    </li>
    <li><a href="matematika.html">1</a></li>
    <li><a href="matematika.html">2</a></li>
    <li><a href="matematika.html">3</a></li>
    <li><a href="matematika.html">4</a></li>
    <li><a href="matematika.html">5</a></li>
    <li>
      <a href="matematika.html" aria-label="Next">
			...
			<div class="row">
				...
				<div class="copyright">
							...
							//<![CDATA[
							  ...
							  <a href="http://spiralpixel.com/">Landa System</a>
						</div>
						</div>
					</div>
				</div>
